...
echo "  Next steps:"
echo ""
echo "  1. Click 'Save skill' in Claude if prompted."
echo ""
echo "  2. Select your AssetWipe project folder in Claude:"
echo "     - Click the folder icon in Claude's toolbar"
echo "     - Navigate to and select: ~/Documents/Claude/Projects/AssetWipe"
echo "     (Claude needs this folder mounted to trigger wipes from the skill)"
echo ""
echo "  3. Say: \"wipe the connected Mac\" and Claude handles the rest."
echo ""
